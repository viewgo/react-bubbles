...
- [x] Explain what a token is used for.
      To authorize a user to make changes to the server/api data.
- [x] What steps can you take in your web apps to keep your data secure?
      Using tokens, user authentication, hiding vital api endpoints behind authentication
- [x] Describe how web servers work.
      It's a program that uses HTTP to send web pages to users that request them
